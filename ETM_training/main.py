...
if args.mode == 'train':
    ...
    #
    filename_beta = 'betas-{}.pt'.format(args.num_topics)
    torch.save(my_beta,filename_beta)
    #
    filename_theta = 'theta-{}.pt'.format(args.num_topics)
    torch.save(my_theta,filename_theta)
    #
    filename_preds = 'preds-{}.pt'.format(args.num_topics)
    torch.save(my_preds,filename_preds)
    #
    filename_rho = 'rho-{}.pt'.format(args.num_topics)
    try:
