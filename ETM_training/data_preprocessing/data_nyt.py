...
max_df = 1
min_df = 1  # choose desired value for min_df

# Read stopwords
#with open('stops.txt', 'r') as f:
with open('stopwords_english_nltk.txt','r') as f:
    stops = f.read().split('\n')

print('My stopwords file is stopwords_english_nltk')
# Read data
print('reading text file...')
#data_file = 'raw/new_york_times_text/nyt_docs.txt' ####CHANGED!
data_file = 'stimuli_243_384.txt'
print('my data_file is stimuli_243_384.txt')
...
path_save = './min_df_' + str(min_df) + 'Pereira_NLTK_Stopwords_/' ########Added "Pereira"
